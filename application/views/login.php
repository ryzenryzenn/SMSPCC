...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
    ...
    <div class="app-content content ">
                ...
                <div class="auth-wrapper auth-v2">
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="<?php echo base_url();?>public/app-assets/images/pages/pair.svg" alt="Login V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Login-->
                            ...
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <form class="auth-login-form mt-2" action="index.html" method="POST">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="login-email" type="text" name="login-email" placeholder="juandelacruz@email.com" aria-describedby="login-email" autofocus="" tabindex="1" />
                                    </div>
                                    <div class="form-group">
                                ...
                                <p class="text-center mt-2"><span>New on our platform?</span><a href="<?php echo base_url(); ?>My_controller/register"><span>&nbsp;Create an account</span></a></p>
                            </div>
                            <!-- /Login-->
                        </div>
                    </div>
        ...
        <!-- BEGIN: Page JS-->
        <script src="<?php echo base_url();?>public/app-assets/js/scripts/pages/page-auth-login.js"></script>
        <!-- END: Page JS-->
